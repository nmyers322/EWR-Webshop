...
<div id="top">
	...
	<div class="a1">Black metal</div>

	<div class="a2">Doom metal</div>

	<div class="a3">Thrash metal</div>

	<div class="a4">Ambient metal</div>

	<div class="a0">FILE EXPLORER</div>
...
<?php print $_LANG["total_used_space"]; ?>: <?php print $total; ?> MB | <?php print $_LANG["free_space"]; ?>: <?php print $free; ?> MB | <a href="http://encode-explorer.siineiolekala.net">encode explorer</a>
